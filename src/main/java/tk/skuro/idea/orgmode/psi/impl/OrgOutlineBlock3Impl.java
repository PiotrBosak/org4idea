...
public class OrgOutlineBlock3Impl extends OrgPsiElementImpl implements OrgOutlineBlock3 {

  public OrgOutlineBlock3Impl(@NotNull ASTNode astNode) {
    super(astNode);
  }

  public void accept(@NotNull OrgVisitor visitor) {
    visitor.visitOutlineBlock3(this);
  }
