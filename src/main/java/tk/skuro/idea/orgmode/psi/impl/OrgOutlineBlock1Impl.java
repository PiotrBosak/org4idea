...
public class OrgOutlineBlock1Impl extends OrgPsiElementImpl implements OrgOutlineBlock1 {

  public OrgOutlineBlock1Impl(@NotNull ASTNode astNode) {
    super(astNode);
  }

  public void accept(@NotNull OrgVisitor visitor) {
    visitor.visitOutlineBlock1(this);
  }
