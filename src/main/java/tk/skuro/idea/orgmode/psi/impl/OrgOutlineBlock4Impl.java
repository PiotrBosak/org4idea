...
public class OrgOutlineBlock4Impl extends OrgPsiElementImpl implements OrgOutlineBlock4 {

  public OrgOutlineBlock4Impl(@NotNull ASTNode astNode) {
    super(astNode);
  }

  public void accept(@NotNull OrgVisitor visitor) {
    visitor.visitOutlineBlock4(this);
  }
