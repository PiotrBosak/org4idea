...
public class OrgOutlineBlock2Impl extends OrgPsiElementImpl implements OrgOutlineBlock2 {

  public OrgOutlineBlock2Impl(@NotNull ASTNode astNode) {
    super(astNode);
  }

  public void accept(@NotNull OrgVisitor visitor) {
    visitor.visitOutlineBlock2(this);
  }
