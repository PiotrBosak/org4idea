...
public class OrgOutlineBlock5Impl extends OrgPsiElementImpl implements OrgOutlineBlock5 {

  public OrgOutlineBlock5Impl(@NotNull ASTNode astNode) {
    super(astNode);
  }

  public void accept(@NotNull OrgVisitor visitor) {
    visitor.visitOutlineBlock5(this);
  }
